...
//Первым делом создать переменную для настроек

$opt_name = 'wayup_options';
	...
	array(
		...
		'fields'             => array(
			array(
				...
				'subtitle' => esc_html__( 'Insert Links for your Social Profiles', 'wayup' ),
				'desc'     => esc_html__( 'Let the field empty if you dont have a link', 'wayup' ),
				'label'    => true,
				'options'  => array(
					'Vkontakte Link'   => '',
					'Facebook Link'   => '',
...
Redux::set_section(	
	$opt_name,
	array(
		'title'            => esc_html__( 'Contact Data', 'wayup' ),
		'id'               => 'contacts',
		'subsection'       => true,
		'desc'             => esc_html__( 'Add Contacts Data to Header and Footer', 'wayup' ),
		'customizer_width' => '450px',
		'fields'             => array(
			array(
				'id'       => 'header-start',
				'type'     => 'section',
				'title'    => esc_html__( 'Header Data', 'wayup' ),
			...
			array(
				...
				'subtitle' => esc_html__( 'Insert the Label', 'wayup' ),
				'default'  => 'Заказать звонок',
			),
			array(
				'id'       => 'header_phone',
				'type'     => 'text',
				'title'    => esc_html__( 'Header Phone', 'wayup' ),
				'subtitle' => esc_html__( 'Insert the Phone', 'wayup' ),	
			),
			array(
				'id'     => 'header-end',
				'type'   => 'section',
			...
			array(
				'id'       => 'footer-start',
				'type'     => 'section',
				'title'    => esc_html__( 'Footer Data', 'wayup' ),
				'indent'   => true, // Indent all options below until the next 'section' option is set.
			),
			array(
				'id'       => 'footer_address',
				'type'     => 'text',
				'title'    => esc_html__( 'Your Address', 'wayup' ),
				'default'  => '',
			),
			...
			array(
				'id'       => 'footer_phone',
				'type'     => 'multi_text',
				'title'    => esc_html__( 'Contact Phone', 'wayup' ),
				'subtitle' => esc_html__( 'Add your Phones', 'wayup' ),
				'desc'     => esc_html__( 'Add or remove items', 'wayup' ),
			),

			array(
				'id'       => 'footer-email',
				'type'     => 'text',
				'title'    => esc_html__( 'Email', 'wayup' ),
				'validate' => 'email',
			...
			array(
				'id'      => 'footer_info',
				'type'    => 'text',
				'title'   => esc_html__( 'Footer Info', 'wayup' ),
				'subtitle' => esc_html__( 'Info after social icons', 'wayup' ),
			),
			array(
			...
			array(
				...
				'type'     => 'section',
				'title'    => esc_html__( 'Footer Section Headers', 'wayup' ),
				'indent'   => true, // Indent all options below until the next 'section' option is set.
			),
			array(
				'id'      => 'footer_section1',
				'type'    => 'text',
				'title'   => esc_html__( 'First Section Title', 'wayup' ),
				'default' => 'Карта сайта',
			),
			...
			array(
				'id'      => 'footer_section2',
				'type'    => 'text',
				'title'   => esc_html__( 'Second Section Title', 'wayup' ),
				'default' => 'Услуги',
			),
			array(
				'id'      => 'footer_section3',
				'type'    => 'text',
				'title'   => esc_html__( 'Third Section Title', 'wayup' ),
				'default' => 'Контакты',
			),
			array(
				'id'      => 'footer_section4',
				'type'    => 'text',
				'title'   => esc_html__( 'Fourth Section Title', 'wayup' ),
				'default' => 'Подписаться на рассылку новстей',
			),
			array(
	...
	Redux::set_section(
		$opt_name,
		array(
			'title'            => esc_html__( 'Home Header', 'wayup' ),
			'id'               => 'home_header',
			'subsection'       => true,
			'desc'             => esc_html__( 'Add Media files and data for Home Header', 'wayup' ),
			'customizer_width' => '450px',
			'fields'             => array(
				array(
					'id'           => 'header_bg',
					'type'         => 'media',
					'url'          => true,
					'title'        => esc_html__( 'Background for for Home Header', 'your-textdomain-here' ),
					'compiler'     => 'true',
					'desc'         => esc_html__( 'Recommended size 1920px*998px', 'your-textdomain-here' ),
					'preview_size' => 'full',
				...
				array(
					'id'      => 'header_time',
					'type'    => 'text',
					'title'   => esc_html__( 'Specify the Time', 'wayup' ),
					'default' => ''
				),
				...
				array(
					'id'      => 'header_video',
					'type'    => 'text',
					'title'   => esc_html__( 'Specify the video', 'wayup' ),
					'default' => '',
					'text_hint' => array(
						'title'   => 'Ссылка с YouTube',
						'content' => 'Используйте простую ссылку из строки браузера на ролок с YouTube'
					)
				),
				array(
					'id'      => 'header_video_title',
					'type'    => 'text',
					'title'   => esc_html__( 'Specify the video tile', 'wayup' ),
					'default' => ''
				),
				array(
	...
	Redux::set_section(
		$opt_name,
		array(
			'title'            => esc_html__( 'Post Types', 'wayup' ),
			'id'               => 'post_types',
			'desc'             => esc_html__( 'Options for Custom Post Types', 'wayup' ),
			'customizer_width' => '400px',
			'icon'             => 'el el-home',
		)
	);
	Redux::set_section(
		$opt_name,
		array(
			'title'            => esc_html__( 'Testimonials', 'wayup' ),
			'id'               => 'testimonials_post_types',
			'subsection'       => true,
			'desc'             => esc_html__( 'Data for Testimonials Page', 'wayup' ),
			'customizer_width' => '450px',
			'fields'             => array(
				...
				array(
					'id'      => 'testy_label1',
					'type'    => 'text',
					'title'   => esc_html__( 'Specify the Label', 'wayup' ),
				...
				array(
					...
					'type'    => 'text',
					'title'   => esc_html__( 'Specify the count of testimonials per page', 'wayup' ),
					'default' => '6'
				),
				array(
					'id'      => 'testimonial_form_shortcode',
					'type'    => 'text',
					'title'   => esc_html__( 'Form Shortcode', 'wayup' ),
